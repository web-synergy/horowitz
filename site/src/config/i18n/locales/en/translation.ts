...
export default {
  navigation: {
    ...
    [EDebut.GROUP_A]: 'A Group Horowitz-Debut',
    [EDebut.GROUP_B]: 'B Group Horowitz-Debut',
    [EDebut.GROUP_C]: 'C Group Horowitz-Debut',
    [EDebut.GROUP_D]: 'D Group Horowitz-Debut',
  },
  buttons: {
    ...
    [ETabs.DEBUT]: 'Debut',
    [ETabs.JUNIOR]: 'Junior',
    [EDebut.GROUP_A]: 'Group A',
    [EDebut.GROUP_B]: 'Group B',
    [EDebut.GROUP_C]: 'Group C',
    [EDebut.GROUP_D]: 'Group D',
  },
