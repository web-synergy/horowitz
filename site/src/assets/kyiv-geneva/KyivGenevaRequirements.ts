...
Р. Шуман. Одна частина з «Фантастичних п’єс» тв. 12 або «Альбому для юнацтва» тв. 68.`,
        `•Один твір українського композитора.`,
        `Приз WFIMC присудять за найкраще виконання в цій категорії. Візьміть до уваги, що С. Прокоф’єв і М. Капустін не вважаються українськими композиторами.`,
        `•Один або декілька творів за вибором учасника.`,
      ],
    },
    thirdRound: {
